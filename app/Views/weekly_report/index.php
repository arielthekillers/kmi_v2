        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
            <div>
                ...
                <div class="relative">
                    ...
                    <select id="month-select" class="block w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm transition-shadow appearance-none cursor-pointer bg-white" onchange="updateWeekOptions()">
                        <?php foreach ($week_options as $key => $opt): ?>
...
<script>
    const groupedOptions = <?= json_encode($week_options) ?>;
    ...
    function updateWeekOptions() {
        ...
        if (groupedOptions[monthKey]) {
            const weeks = groupedOptions[monthKey].weeks;
            weeks.forEach(week => {
