                                        ...
                                        <?php foreach ($class_students as $s): ?>
                                            <tr class="hover:bg-slate-50/40 transition-all">
                                                ...
                                                <td class="p-4 pr-6 text-right flex justify-end gap-2">
                                                    <a href="<?= url('/student-development/student?id=' . $s['id'] . '&back=' . urlencode(url('/classes/detail?id=' . $kelas['id'] . '&tab=perkembangan'))) ?>" class="bg-indigo-50 hover:bg-indigo-100 text-indigo-600 text-xs font-semibold px-3.5 py-1.5 rounded-xl border border-indigo-100 transition-all flex items-center gap-1">
